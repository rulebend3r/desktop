--[[
     ...
     rulebend3r Awesome WM theme 2.0
...
local mytextclock = wibox.widget.textclock("<span font='Sony Sketch EF 5'> </span>%H:%M ")
...
function theme.at_screen_connect(s)
    ...
    s.myverticalwibox = awful.wibar({ position = "right", screen = s, width = 360, bg = theme.bg_normal, fg = theme.fg_normal })
