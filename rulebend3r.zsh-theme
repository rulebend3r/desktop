...
$PR_GREEN%$PR_PWDLEN<...<%~%<<\
$PR_BLUE)`rvm_prompt_info || rbenv_prompt_info`$PR_CYAN$PR_HBAR$PR_HBAR${(e)PR_FILLBAR}$PR_HBAR$PR_BLUE(\
$PR_CYAN%(!.%SROOT%s.%n)$PR_BLUE@$PR_GREEN%m:%l\
...
($PR_MAGENTA%D{%a,%b%d}$PR_BLUE)$PR_HBAR$PR_CYAN$PR_LRCORNER$PR_NO_COLOUR'
